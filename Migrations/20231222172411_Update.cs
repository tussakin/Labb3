    ...
    public partial class Update : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Course__C92D718746CA3F48", x => x.CourseID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Professi__3F309E1F67BA9BD9", x => x.ProfessionID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Staff__96D4AAF7FB4158AA", x => x.StaffID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Students__32C52A7911F00921", x => x.StudentID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Grade__54F87A3719E7AF82", x => x.GradeID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__GradeDet__41C6FC3EBE843C97", x => x.GradeDetailID);
                    table.ForeignKey(
